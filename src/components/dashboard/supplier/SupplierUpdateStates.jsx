                ...
                <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0  ">
                    <div className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                        <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                            ...
                            <form className="max-w-sm mx-auto my-4 mb-6" onSubmit={handleFormSubmit}>
                                ...
                                >
                                    ...
                                    <option className='font-medium text-center p-2 rounded-lg h-8 flex items-center justify-center w-20 mx-auto' value="approve">Approve</option>
